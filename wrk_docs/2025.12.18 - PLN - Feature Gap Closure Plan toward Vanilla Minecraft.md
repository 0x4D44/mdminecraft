...
**Implementation journal:** `wrk_journals/2025.12.18 - JRN - Vanilla Parity Implementation.md`  
...
- **Stage 4 in progress:** collisions + placement rules were upgraded for common non-cube blocks (stairs/slabs/trapdoors/doors/fences/panes/gates), and custom meshing has started for panes/fences/gates/stairs (see journal for exact changes).
- **Stage 3 survival content expanded:** sugar cane worldgen + deterministic growth, sugar/paper/book crafting chain, bookshelf recipe updated to use books, and brewing sugar now unlocks Swiftness (see journal).
