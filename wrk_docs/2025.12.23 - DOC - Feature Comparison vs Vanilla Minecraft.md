...
- Skeletons now have a small deterministic chance to drop a bow.
...
- A real `fire` block now exists and ignites entities on contact; it can be created via flint-and-steel, lightning strikes, and (simplified) lava ignition. Vanilla fire age/spread rules, soul fire, and many edge interactions remain unimplemented/simplified.
