...
pub use chunk::{
    ...
    BLOCK_CRAFTING_TABLE, BLOCK_DIAMOND_ORE, BLOCK_ENCHANTING_TABLE, BLOCK_FURNACE,
    BLOCK_FURNACE_LIT, BLOCK_GOLD_ORE, BLOCK_IRON_ORE, BLOCK_LAPIS_ORE, BLOCK_STONE, CHUNK_SIZE_X,
