...
- **Stage 10 redstone expansion continued:** comparators are now craftable/placeable; right-click toggles subtract mode; output is 1-tick delayed + directional. Nether quartz is obtainable via a deterministic Overworld proxy ore (`nether_quartz_ore`) to support survival crafting (see journal).
...
**Engineering**
- Add core components: repeater (**done**), comparator (**done**), observer (**done**), piston (**done**), dispenser/dropper, hopper.
